...
import { MenuModule } from "src/entities/menu/menu.module";
import { MenuEntity } from "src/entities/menu/menu.entity";
...
@Module({
  imports: [
    ...
    TypeOrmModule.forRoot({
      ...
      entities: [UserEntity, PersonalDataEntity, MenuEntity],
      synchronize: true,
    }),
    AuthModule,
    UserModule,
